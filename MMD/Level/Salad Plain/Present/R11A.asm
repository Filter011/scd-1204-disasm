...
ZeroOffsetOptimization = 0
	...
	phase	wkram	; set section to use workram
...
gmmode_ptr	macro	gmmode,{INTLABEL}
__LABEL__:	label	*-gamemode_index
	bra.w	gmmode
	endm

gmmodeid_lvl:	gmmode_ptr	level
...
fadein:
	moveq	#0,d0
	lea	(palette).w,a0
	move.b	(startcolor).w,d0
	adda.w	d0,a0
	moveq	#$000,d1
	move.b	(colorcnt).w,d0
...
pal_ptr	macro	ptr,line,size,{INTLABEL}
__LABEL__:	label	(*-pal_index)/8
	dc.l	ptr
	dc.w	palette+line*$10
	dc.w	size/2-1
	endm

palid_segabg:	pal_ptr pal_segabg,0,64
palid_title:	pal_ptr pal_title,0,64
palid_levelsel:	pal_ptr pal_levelsel,0,64
palid_player:	pal_ptr pal_player,0,16
palid_spz:	pal_ptr pal_spz,2,$30

pal_segabg:
;	incbin	"Palettes/Sega Background (Sonic 1).bin"
;	even
...
calcsine:
	...
	add.w	d0,d0
	addi.w	#$80,d0
	move.w	sinetbl(pc,d0.w),d1
	subi.w	#$80,d0
	move.w	sinetbl(pc,d0.w),d0
	rts
...
sinetbl:
	...
	dc.w	0,-6,-12,-18,-25,-31,-37,-43
	dc.w	-49,-56,-62,-68,-74,-80,-86,-92
	dc.w	-97,-103,-109,-117,-120,-126,-131,-136
	dc.w	-142,-147,-152,-157,-162,-167,-171,-176
	dc.w	-181,-185,-189,-193,-197,-201,-205,-209
	dc.w	-212,-216,-219,-222,-225,-228,-231,-234
	dc.w	-236,-238,-241,-243,-244,-246,-248,-249
...
vint_ptr	macro	ptr,{INTLABEL}
__LABEL__:	label	*-vint_index
	dc.w ptr-vint_index
	endm

vintid_00:	vint_ptr vint00
vintid_02:	vint_ptr vint02
vintid_04:	vint_ptr vint04
vintid_06:	vint_ptr vint06
vintid_08:	vint_ptr vint08
vintid_0A:	vint_ptr vint0A
vintid_0C:	vint_ptr vint0C
vintid_0E:	vint_ptr vint0E
vintid_10:	vint_ptr vint10
vintid_12:	vint_ptr vint12
vintid_14:	vint_ptr vint14
vintid_16:	vint_ptr vint16
vintid_18:	vint_ptr vint18
...
loc_20180E:
	...
	tst.b	(byte_FFF767).w
	beq.s	loc_201892
	DMA68K	playwrtwk,(playwrtwk_end-playwrtwk),4,$780*tile_size
...
loc_201892:
	...
	tst.b	(byte_FFF767).w
	beq.s	loc_2018CA
	DMA68K	playwrtwk,(playwrtwk_end-playwrtwk),4,$797*tile_size
	move.b	#0,(byte_FFF767).w
...
sub_2030F2:
	lea	(actwk).w,a0
	moveq	#(byte_FFD800_end-actwk)/obj.len-1,d7
	moveq	#0,d0
loc_2030FA:
	move.b	(a0),d0
	beq.s	loc_203110
...
loc_203110:
	...
	moveq	#(byte_FFD800-actwk)/obj.len-1,d7
	bsr.s	loc_2030FA
	moveq	#$1800/obj.len-1,d7
loc_203120:
	moveq	#0,d0
	move.b	(a0),d0
	beq.s	loc_203130
...
obj_ptr	macro	ptr,{INTLABEL}
__LABEL__:	label	(*-off_2034AE+4)/4
	dc.l ptr
	endm

objid_00:	equ	0
objid_01:	obj_ptr obj01
objid_02:	obj_ptr obj02
objid_03:	obj_ptr obj03
objid_04:	obj_ptr obj04
objid_05:	obj_ptr obj05
objid_06:	obj_ptr obj06
objid_07:	obj_ptr obj07
objid_08:	obj_ptr obj08
objid_09:	obj_ptr obj09
objid_0A:	obj_ptr obj0A
objid_0B:	obj_ptr obj0B
objid_0C:	obj_ptr obj0C
objid_0D:	obj_ptr obj0D
objid_0E:	obj_ptr obj0E
objid_0F:	obj_ptr obj0F
objid_10:	obj_ptr obj10
objid_11:	obj_ptr obj11
objid_12:	obj_ptr obj12
objid_13:	obj_ptr obj13
objid_14:	obj_ptr obj14
objid_15:	obj_ptr obj15
objid_16:	obj_ptr obj16
objid_17:	obj_ptr obj17
objid_18:	obj_ptr obj18
objid_19:	obj_ptr obj19
objid_1A:	obj_ptr obj1A
objid_1B:	obj_ptr obj1B
objid_1C:	obj_ptr obj1C
objid_1D:	obj_ptr obj1D
objid_1E:	obj_ptr obj1E
objid_1F:	obj_ptr obj1F
objid_20:	obj_ptr obj20
objid_21:	obj_ptr obj21
objid_22:	obj_ptr obj22
objid_23:	obj_ptr obj23
objid_24:	obj_ptr obj24
objid_25:	obj_ptr obj25
objid_26:	obj_ptr obj26
objid_27:	obj_ptr obj27
objid_28:	obj_ptr obj28
objid_29:	obj_ptr obj29
...
locret_203614:
	...
	include	"Objects/01, 02 - Player.asm"
...
loc_2059DC:
	...
	DMA68K	powerupwrtwk,(powerupwrtwk_dma_end-powerupwrtwk),4,$544*tile_size
...
loc_2063DC:
	...
	move.w	#(byte_FFD800_end-byte_FFD800)/obj.len-1,d6
loc_2063EA:
	tst.b	obj.render(a1)
	bpl.s	loc_2063F6
...
findfreeobj:
	lea	(byte_FFD800).w,a1
	move.w	#(byte_FFD800_end-byte_FFD800)/obj.len-1,d0
loc_206F8E:
	tst.b	obj.id(a1)
	beq.s	locret_206F9A
	lea	obj.len(a1),a1
...
sub_206F9C:
	movea.l a0,a1
	move.w	#byte_FFD800_end&$FFFF,d0
	sub.w	a0,d0
	lsr.w	#6,d0
	subq.w	#1,d0
	bcs.s	locret_206FB6
...
sub_207EDC:
	...
	beq.s	loc_207F0A
	move.b	#playheight,obj.height(a1)
	move.b	#playwidth,obj.width(a1)
...
loc_20829A:
	...
	tst.b	(chibi_flag).w
	beq.s	loc_2082EE
	move.b	#chibiheight,obj.height(a1)
	move.b	#chibiwidth,obj.width(a1)
	bra.s	loc_2082FA
...
loc_208316:
	move.b	#rollheight,obj.height(a1)
	move.b	#rollwidth,obj.width(a1)
...
loc_20D1AC:
	...
	move.w	#9,d2
	_move.b	obj.id(a0),obj.field_3F(a0)
	_clr.b	obj.id(a0)
loc_20D1CE:
	move.w	a5,d5
	move.w	a2,d3
...
loc_20D1D4:
	...
	_move.b	obj.field_3F(a0),obj.id(a1)
...
ddev_header	macro	label
	dc.w	(label)/6-1
	endm

ddev_entry	macro	label,vram
	dc.l	label
	dc.w	vram*tile_size
	endm
...
ddev_ptr	macro	ptr,{INTLABEL}
__LABEL__:	label	(*-divdev_index)/2
	dc.w ptr-divdev_index
	endm

ddevid_00:	ddev_ptr ddev_00
ddevid_01:	ddev_ptr ddev_01
ddevid_02:	ddev_ptr ddev_02
ddevid_03:	ddev_ptr ddev_03
ddevid_04:	ddev_ptr ddev_04
ddevid_05:	ddev_ptr ddev_05
ddevid_06:	ddev_ptr ddev_06
ddevid_07:	ddev_ptr ddev_07
ddevid_08:	ddev_ptr ddev_08
ddevid_09:	ddev_ptr ddev_09
ddevid_0A:	ddev_ptr ddev_0A
ddevid_0B:	ddev_ptr ddev_0B
ddevid_0C:	ddev_ptr ddev_0C
ddevid_0D:	ddev_ptr ddev_0D
ddevid_0E:	ddev_ptr ddev_0E
ddevid_0F:	ddev_ptr ddev_0F
...
spz_16x16:
	incbin	"Blocks/Blocks.nem"
	even

spz_8x8:
	incbin	"Art/Nemesis/8x8 - SPZ.nem"
	even
